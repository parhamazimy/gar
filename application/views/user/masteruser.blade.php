				        ...
				        <li id="mega_menu_btn">
							...
							<div id="mega_menu" class="t#333 b#ffb b%9">
								...
								<ul class="col-sm-4 icon">
									<li><h4>لینک به همراه آیکون</h4></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-user"></i> ویرایش پروفایل</a></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-send-o"></i>ثبت درخواست</a></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-plane"></i>ماموریت</a></li>
								</ul>
								<ul class="col-sm-4 icon">
									<li><h4>لینک به همراه آیکون</h4></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-sign-language"></i>تنبیهی و تشویقی</a></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-hourglass"></i>مرخصی</a></li>
									<li><a href="#" class="b%0=5"><i class="fa fa-tasks"></i>اضافه خدمت ناشی از خلاء</a></li>
								</ul>
				...
				<!-- accordion menu -->
	 			<div id="cssmenu">
				    <ul>
                        ...
                        <li>
                            <a href="index.html">
                                <i class="fa fa-plane t#ac6bec"></i>ماموریت
                            </a>
                        </li>
