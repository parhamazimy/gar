            ...
            <td id="column0" class="connectcolumn" colspan="2">
                ...
                <div class="panel" id="popover">
                    <div class="panel-heading b#dfffc6">
                        <i class="fa fa-plus-circle sort-hand"></i>   ثبت نیرو
                    ...
                    <div class="panel-body text-center">
                        ...
                        <div class="form-group ">
                            <label class="col-sm-2  control-label" >واحد خدمت</label>
                            <div class="col-sm-4">
                                <input name="serviceunit" class="form-control" required>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-4">
                                    <input readonly placeholder="تاریخ " type="text" id="pcal4" class="pdate full-width has-padding has-border" name="timelastfinish">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3  control-label">میزان کسری خدمت تأییدشده  </label>
                                <div class="col-sm-3">
                                    <input   placeholder="بر حسب روز" type="number"  class="form-control" name="deficit" required>
                                </div>
                            ...
                            <div class="form-group ">
                                <label class="col-sm-2  control-label" > وضعیت سلامتی روانی</label>
                                <div class="col-sm-4">
                                ...
                                <label class="col-sm-2  control-label" > وضعیت سلامتی جسمانی</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-2 control-label">سوابق خدمت قبلی</label>
                               <div class="col-sm-4">
                                   <input class="form-control" required name="history">
                               </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-sm-4">
                                    <input name="sect" type="text" class="form-control"   required>
                                </div>
                            </div>
                            <div class="form-group ">
...
@section('js')
    ...
    <script>
        ...
        var objCal3 = new AMIB.persianCalendar( 'pcal4',{
            extraInputID: 'pcal4',
            extraInputFormat: 'yyyy/mm/dd',
            initialDate: '1396/02/01'
        } );
