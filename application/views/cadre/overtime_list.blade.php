...
@section('content')
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-3 text-center">
                    <a target="_blank" class="btn btn-primary" href="{{base_url('backup/overtime')}}"><i class="fa fa-archive"></i>  پشتیبان گیری به صورت فایل اکسل </a>
                </div>
            </div>
    ...
    <!-- /End Basic table -->
    {!! form_open('cadre/overtime_list','style="display: none" id="delete" ') !!}
    {!! form_close() !!}
