                        ...
                        <section id="show">
                            <div class="form-group ">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    @else
                                    <input readonly placeholder="تاریخ " value="{{mds_date('y/m/d',$user->timearrival)}}" type="text" id="pcal1" class="pdate full-width has-padding has-border" name="timedispatch">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group ">
